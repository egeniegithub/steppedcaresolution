<!-- Delete Modal -->
<div class="modal fade" id="project_delete_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer users_modal_footer">
                <a type="button" class="btn btn-primary project_delete_modal_btn text-white" data-dismiss="modal">Delete</a>
